...
const Main = () => {
  return (
    ...
    <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
      ...
      <div>
       <button className='text-white group border-2 px-6 py-3 my-2 flex items-center hover:bg-[#FF2E63] hover:border-[#FF2E63] hover:scale-110 duration-500'>
       <Link href={"./Work.jsx"} to="work" smooth={true} duration={500}>
          View Work
        </Link> 
